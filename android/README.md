# Distance Calculator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:distancecalculator-api:1.1.12'
}
```
...
```java
import com.apiverve.distancecalculator.DistanceCalculatorAPIClient;
import com.apiverve.distancecalculator.APIResponse;
import com.apiverve.distancecalculator.APIException;

// Initialize the client
DistanceCalculatorAPIClient client = new DistanceCalculatorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/distancecalculator](https://docs.apiverve.com/ref/distancecalculator)
...
- **Documentation:** [https://docs.apiverve.com/ref/distancecalculator](https://docs.apiverve.com/ref/distancecalculator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/distancecalculator-api/issues)
