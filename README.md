...
```bash
curl -X GET "https://api.apiverve.com/v1/distancecalculator?param=value" \
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/distancecalculator](https://docs.apiverve.com/ref/distancecalculator)

---

## Use Cases

Common use cases for the Distance Calculator API:
